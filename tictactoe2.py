...
class AI(Player):
    def make_move(self, board):
        ...
        for coordinate in free_coordinates:
            ...
            best_utility_sofar = max(best_utility_sofar, AI.get_min_utility(board.result(self.marker, coordinate)))
        ...
        for coordinate in free_coordinates:
            if AI.get_min_utility(board.result(self.marker, coordinate)) == best_utility_sofar:
                pos = Board.position_from_coordinate(coordinate)
                print(f"Position decided: {pos}")
                return pos
    ...
    def get_max_utility(state):
        ...
        for coordinate in free_coordinates:
            ...
            min_util_resultant_state = self.get_min_utility(resultant_state)
